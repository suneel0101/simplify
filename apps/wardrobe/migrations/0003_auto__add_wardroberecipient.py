...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WardrobeRecipient'
        db.create_table(u'wardrobe_wardroberecipient', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=12)),
        ))
        db.send_create_signal(u'wardrobe', ['WardrobeRecipient'])

    def backwards(self, orm):
        # Deleting model 'WardrobeRecipient'
        db.delete_table(u'wardrobe_wardroberecipient')
    ...
    models = {
        ...
        u'wardrobe.wardroberecipient': {
            'Meta': {'object_name': 'WardrobeRecipient'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
