...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MealRecipient'
        db.create_table(u'meal_mealrecipient', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=12)),
        ))
        db.send_create_signal(u'meal', ['MealRecipient'])

    def backwards(self, orm):
        # Deleting model 'MealRecipient'
        db.delete_table(u'meal_mealrecipient')
    ...
    models = {
        ...
        u'meal.mealrecipient': {
            'Meta': {'object_name': 'MealRecipient'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
